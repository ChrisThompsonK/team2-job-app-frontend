	...
	describe("validateJobRoleId", () => {
		...
		describe("invalid inputs", () => {
			...
			it("should return null for non-string input", () => {
				...
				expect(validateJobRoleId(null as any)).toBe(null);
				expect(validateJobRoleId(123 as any)).toBe(null);
				expect(validateJobRoleId([] as any)).toBe(null);
				expect(validateJobRoleId({} as any)).toBe(null);
			});
	...
	describe("sanitizeString", () => {
		...
		describe("XSS prevention", () => {
			...
			it("should handle data URIs and other injection attempts", () => {
				...
				expect(
					sanitizeString('<iframe src="javascript:alert(1)"></iframe>')
				).toBe(
		...
		describe("edge cases", () => {
			...
			it("should handle unicode and special characters", () => {
				...
				expect(sanitizeString("🔥 <hot> content")).toBe(
					"🔥 &lt;hot&gt; content"
				);
			});
		});
